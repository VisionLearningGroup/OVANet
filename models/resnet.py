...
def resnet50_moco(pretrained=True):
    """Constructs a ResNet-50 model.
    Args:
      pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    ...
    #import pdb
    #pdb.set_trace()
    moco_dict = torch.load("/home/grad3/keisaito/domain_adaptation/net_decide/moco_v2_800ep_pretrain.pth.tar")['state_dict']
    new_dict = {}
    for k, v in moco_dict.items():
        new_key = k.replace('module.encoder_q.', '')
        new_dict[new_key] = v
    model.load_state_dict(new_dict, strict=False)
        # #checkpoint = torch.load("/home/grad3/keisaito/domain_adaptation/net_decide/moco_v2_800ep_pretrain.pth.tar",
        #                         map_location="cpu")
